...
LABEL org.opencontainers.image.source=https://github.com/PrashamTrivedi/MyDockerFiles/.gitpod_hugo.Dockerfile
LABEL org.opencontainers.image.ref.name=gitpod_hugo
LABEL org.opencontainers.image.title=gitpod_hugo
